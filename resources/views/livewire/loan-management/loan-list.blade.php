...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
  ...
  <div class="mx-auto my-10 text-center sm:flex sm:flex-wrap sm:justify-center">
    <a href="{{ route('loans.add') }}" class="inline-block bg-blue-500 text-white px-6 py-3 rounded-md hover:bg-blue-600 transition duration-200 mb-2 sm:mr-2 sm:mb-0">
      Loan a book
    </a>
    <a href="{{ route('returned.loans') }}" class="inline-block bg-red-500 text-white px-6 py-3 rounded-md hover:bg-red-600 transition duration-200 mb-2 sm:mr-2 sm:mb-0">
      Show Returned Loans
    </a>
